...
public class Mailbox {
    ...
    public  void put(int value){
        try{
            ...
            // If the permit in the empty slot equals to 0, then the thread that is accessing the put() will be blocked.
            // until a permit becomes available.
            // The thread will go into the WAITING state.
    ...
    public  int get(){
        ...
        try{
            ...
            // If the number of permit in the fullSlots is 0 , then the thread calling the get() will block.
            // until such time the permit becomes available.
            // If the thread cannot acquire the permit will be in the WAITING state.
            mutex.acquire();
            value = item.remove(0);
